...
/*accountRepositryで検索されたものを使って処理をするのがアカウントサービス*/
//問３－１ Serviceであることを表すアノテーションを記述
@Service
public class AccountService implements UserDetailsService {

    //問３－２ 自動でインスタンス生成をするアノテーションを記述
	@Autowired /*@Resource*//*@Autowiredは別のクラスを使えるようにしてくれるもの*/
	...
	/*ユーザーネームの値がNULLだった場合、エラーを出してください*/
    @Override
    public Account loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        /*usernameをアカウントリストから全件検索した結果見つからなかったらエラーを出してください*/
